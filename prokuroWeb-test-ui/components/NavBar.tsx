...
export default function NavBar({ onLogoClick }: NavBarProps) {
  return (
    <header className="sticky top-0 z-50 h-14 border-b border-hairline bg-canvas/90 backdrop-blur-sm">
      <div className="mx-auto flex h-full max-w-screen-xl items-center justify-between px-6">
        ...
        <nav className="flex items-center gap-1">
          <a
            ...
            className="flex h-8 items-center gap-1.5 rounded-md px-3 text-[13px] font-medium text-ink-subtle transition-colors hover:bg-surface-1 hover:text-ink"
          >
            <GitHubIcon />
            GitHub
          </a>
